...
import { n as init_babel, parsers as Aa, t as babel_exports } from "./babel-DikxBozH.js";
import index_exports, { t as init_prettier } from "./prettier-IUhF8k6R.js";
import { a as __toESM$1, t as __commonJSMin } from "./chunk-DSjvVL_1-CFRAhFED.js";
import { a as sortClasses, c as cacheForDirs, d as expiringMap, f as loadIfExists, i as sortClassList, l as spliceChangesIntoString, n as error, o as warn, p as maybeResolve, r as getTailwindConfig$1, u as visit } from "./sorter-BZkvDMjt-DETsV-lQ.js";
import { parsers as Cn, t as init_angular } from "./angular-CkW6y8HF.js";
import { n as postcss_exports, parsers as cn, t as init_postcss } from "./postcss-BWxhYexP.js";
import * as path from "node:path";
import { isAbsolute } from "path";
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.2b6f3c2_prettier-plugin-svelte@4.1.1_prettie_43204ce365e0600d5f5bf1a5b3c44d6e/node_modules/prettier-plugin-tailwindcss/dist/index.mjs
init_angular();
init_babel();
init_postcss();
init_prettier();
...
const { parsers, printers } = createPlugin([
	...
	defineTransform({
		...
		parsers: {
			...
			acorn: { load: [{
				...
				importer: () => import("./acorn-CdTF_M80.js")
			}] },
			flow: { load: [{
				name: "prettier/plugins/flow",
				importer: () => import("./flow-CGr7c46o.js")
			}] },
			oxc: { load: [{
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./plugin-CRy8i7Rc.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))
		}],
		parsers: { svelte: {} },
		printers: { "svelte-ast": {} },
