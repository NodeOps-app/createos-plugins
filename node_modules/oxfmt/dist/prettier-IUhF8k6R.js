...
function expand_(str, max, isTop) {
	...
	if (m.pre.endsWith('$')) for (let k = 0; k < post.length && k < max; k++) {
...
var init_prettier = __esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			...
			name: "markdown",
			load: () => import("./markdown-CSUYvYg6.js"),
			...
			name: "postcss",
			load: () => import("./postcss-BWxhYexP.js"),
	...
	require_ignore = __commonJS({ "node_modules/ignore/index.js"(exports, module) {
		...
		var REPLACERS = [
			...
			[/(?:[^*])$/, (match2) => match2.endsWith('/') ? `${match2}$` : `${match2}(?=$|\\/$)`]
		];
